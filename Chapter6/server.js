...
<div class="mb-3">
 ...
 <textarea type="text" class="form-control" id="bio" name="bio">Follower of Christ | Author of Best-selling Amazon Tech Books and Creator of Coding Courses
 </textarea> 
</div>
...
app.put('/user/:id', (req, res) => {
    ...
    >
    <div class="card-body">
    <h5 class="card-title">${name}</h5> <p class="card-text">
    ${bio} </p>
    <button href="#" class="btn btn-primary" hx-get="/user/1/edit">
    Click To Edit
    </button> </div>
    </div> `);
});
